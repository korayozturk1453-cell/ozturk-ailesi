...
object FamilySyncHelper {
    ...
    fun exportBackupToJson(
        ...
        memories.forEach { mem ->
            ...
            obj.put("imagePath", mem.photoPath ?: "")
            memsArray.put(obj)
        }
        ...
        milestones.forEach { m ->
            ...
            obj.put("targetAgeMonths", 0)
            obj.put("achievedDate", m.completedDate ?: 0L)
            ...
            for (i in 0 until memsArray.length()) {
                ...
                memories.add(
                    MemoryEntry(
                        ...
                        photoPath = obj.optString("imagePath").ifBlank { null }
                    )
                )
            }
        }
            ...
            for (i in 0 until milesArray.length()) {
                ...
                milestones.add(
                    ChildMilestone(
                        ...
                        completedDate = obj.optLong("achievedDate", 0L).takeIf { it > 0L },
